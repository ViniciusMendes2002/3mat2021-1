...
class FormaGeometrica {
    ...
    */
    ...
    /*********************************************************
        PROPRIEDADE CALCULADA: é uma propriedade somente-leitura (portanto, tem apenas
        o getter) cujo valor é calculado com base em outros atributos e propriedades.
        O cálculo acontece "ao vivo", ou seja, é efetuado no momento em que o getter
        é acionado.
     *********************************************************/
...
// Tentando adicionar uma propriedade 'descrição' ao objeto. Não dá certo,
...
// Cálculo de área via método
console.log('Área da forma1:' , forma1.calcularArea())

// Cálculo de área via propriedade
