...
let pessoa = {
    ...
    // Tembém chamados de atributos: valor
    nome: 'Orkutilson Da Silva',
    dataNasc: '2009-01-29',
    sexo: 'M',
    ocupacao: 'estudante',
    // Nomes de propriedades podem ter espaço e/ou acentos,
...
// Foi criada a porpiredade marca e colocado o valor 'Volkswagen' dentro dela
