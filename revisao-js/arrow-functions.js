...
// O formato da função acima é perfeito para conversão em arrow function,
...
// Arrow Function equlivalente no exemplo abaixo.
// Quando temos mais de um parâmetro, os parênteses precisam ser colocados (b, e)
...
// Arrow Function equivalente no exemplo abaixo.
...
// Arrow Function equivalente no exemplo abaixo.
// Com mais de uma linha no corpo, as chaves voltam e não é mais possível
// omitir a palavra-chave no *return* caso a função retorne valor 
const somaVet2 = vet => {
    let soma = 0
    for(let n of vet) soma += n // soma = soma + n
    return soma 
...
// possui apenas uma linha, embora uma arrow functions com múltiplas linhas não sejam incomuns.
